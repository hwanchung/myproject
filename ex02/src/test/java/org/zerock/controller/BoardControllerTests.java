...
public class BoardControllerTests {
	...
	public void testGet() throws Exception {
		...
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/get").param("bno", "20")).andReturn()
	...
	public void testRemove() throws Exception {
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "18")).andReturn()
